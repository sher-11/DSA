...
function lowestPositiveNumber(arr) {
    const sortedArray = arr.sort();
    let lowestPositiveNumber = 1;

    for (let i = 0; i < sortedArray.length; i++) {
        if(lowestPositiveNumber == sortedArray[i]) {
...
console.log(lowestPositiveNumber([1, 3, 6, 4, 1, 2]))
console.log(lowestPositiveNumber([1, 2, 3]))
// console.log(lowestPositiveNumber([−1, −3]))